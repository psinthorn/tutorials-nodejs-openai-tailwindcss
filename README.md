...
> ใช้คำสั่ง npm run tailwind:css ทุกครั้งที่มีการเปลี่ยนแปลงค่า css ในโปรเจคเพื่อทำหารอัพเดทค่า css ไปที่ไฟล์ style.css ที่ได้กำหนดไว้ หากไม่ทำการ run คำสั่ง npm run tailwind:css จะไม่มีการเปลี่ยนแปลงใดๆ เกิดขึ้น
